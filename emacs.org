...
*** revert buffer
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>br") 'revert-buffer)
#+END_SRC
...
*** ctrl + x + {+,-}
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>l")
    (lambda ()
      (interactive)
      (text-scale-adjust 1)))

  (evil-define-key 'normal 'global (kbd "<SPC>h")
    (lambda ()
      (interactive)
      (text-scale-adjust -1)))

  (evil-define-key 'normal 'global (kbd "<SPC>j")
    (lambda ()
      (interactive)
      (text-scale-adjust 0)))
#+END_SRC
