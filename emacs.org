...
*** groups
#+BEGIN_SRC emacs-lisp
  (which-key-add-key-based-replacements "<SPC>b" "buffer/bookmark/recentf")
...
*** open timesheet and export
#+BEGIN_SRC emacs-lisp
  (which-key-add-key-based-replacements "<SPC>O" "open timesheet and export")
  (evil-define-key 'normal 'global (kbd "<SPC>O")
    (lambda ()
      (interactive)
      (r760-timesheet "~/wlog")
...
*** list buffers
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>bl") 'helm-buffers-list)
#+END_SRC
