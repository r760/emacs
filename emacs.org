...
*** eval-current-file-in-interpreter
#+BEGIN_SRC emacs-lisp
  (defun r760-eval-current-file-in-interpreter (interpreter-path)
    "evaluate the current file in the given interpreter"
    (interactive)
    (let (fpath)
      (setq fpath (concat interpreter-path" " (buffer-file-name)))
      (async-shell-command fpath)))
#+END_SRC
...
*** groups
#+BEGIN_SRC emacs-lisp
  (which-key-add-key-based-replacements "<SPC>b" "bookmark/recentf")
  (which-key-add-key-based-replacements "<SPC>c" "compilation")
  (which-key-add-key-based-replacements "<SPC>g" "git")
  (which-key-add-key-based-replacements "<SPC>i" "interactive")
  (which-key-add-key-based-replacements "<SPC>m" "man")
...
*** gdb
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>cg") 'gdb)
#+END_SRC
...
*** evaluate current file in bash
#+BEGIN_SRC emacs-lisp
  (which-key-add-key-based-replacements "<SPC>se" "evaluate current file in bash")
  (evil-define-key 'normal 'global (kbd "<SPC>se")
    (lambda ()
      (interactive)
      (r760-eval-current-file-in-interpreter "/bin/bash")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>wu") 'winner-undo)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal 'global (kbd "<SPC>o")
    (lambda ()
      ...
      (interactive)
      (let (fpath)
        (setq fpath (concat "~/wlog/" (format-time-string "%Y-%m-%d") ".org"))
        (find-file fpath)
...
*** jump to bookmark
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>bj") 'helm-bookmarks)
#+END_SRC

*** open a recent file
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>br") 'recentf-open-files)
#+END_SRC

*** man
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal 'global (kbd "<SPC>mm") 'man)
#+END_SRC
